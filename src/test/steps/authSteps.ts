...
Given(`the user provides valid API credentials with email {string} and password {string}`, async function (email, password) {
...
Then(`the access token should be saved in the authentication file`, async function () {
    if (!this.accessToken) {
